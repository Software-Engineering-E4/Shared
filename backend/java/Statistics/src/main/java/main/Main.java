...
import main.barchart.BarChartRedditPosts;
import main.barchart.BarChartYoutube;
import main.linechart.LineChartRedditPosts;
import main.linechart.LineChartYoutube;
import main.piechart.PieChartRedditPosts;
import main.piechart.PieChartTwitterPosts;
import main.piechart.PieChartYoutube;
...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        File file = new File("src/main/resources/BarChartYoutubeVideos.png");
        if (file.delete()) {
        ...
        file = new File("src/main/resources/BarChartRedditPosts.png");
        if (file.delete()) {
            System.out.println("Deleted");
        }
        try {
        ...
        file = new File("src/main/resources/LineChartRedditPosts.png");
        if (file.delete()) {
            System.out.println("Deleted");
        }
        try {
        ...
        file = new File("src/main/resources/LineChartYoutube.png");
        if (file.delete()) {
            System.out.println("Deleted");
        }
        try {
        ...
        file = new File("src/main/resources/PieChartRedditPosts.png");
        if (file.delete()) {
            System.out.println("Deleted");
        }
        try {
        ...
        file = new File("src/main/resources/PieChartTwitterPosts.png");
        if (file.delete()) {
            System.out.println("Deleted");
        }
        try {
        ...
        file = new File("src/main/resources/PieChartYoutubeVideos.png");
        if (file.delete()) {
            System.out.println("Deleted");
        }
        try {
